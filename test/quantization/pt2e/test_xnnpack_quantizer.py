...
class TestXNNPACKQuantizer(PT2EQuantizationTestCase):
    ...
    def test_set_module_name_with_underscores(self) -> None:
        ...
        quantizer.set_module_name("foo_bar", get_symmetric_quantization_config(is_per_channel=True))
        ...
        for n in m.graph.nodes:
            if n.op == "call_function" and n.target == torch.ops.aten.linear.default:
                ...
                if count == 0:
                    ...
                    self.assertEqual(observer_instance.qscheme, torch.per_channel_symmetric)
                else:
